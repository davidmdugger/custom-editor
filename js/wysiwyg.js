...
function getData(){ // NOT WORKING
  data = iframe.textContent;
  renderData(data);
}

function renderData(data){ // NOT WORKING
  var outputShit = document.getElementById('outputShit');
  outputShit.innerHTML = data;
}

document.getElementById('submitData').addEventListener('click', getData);
